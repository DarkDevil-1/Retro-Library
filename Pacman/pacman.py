def pac():
    ...
    # Ghost class to define all of the ghosts
    class Ghost:
        ...
        # function to move clyde (orange ghost)
        # R = 0, L = 1, U = 2, D = 3
        def move_clyde(self):
            # r, l, u, d
    ...
    # function to check if pacman character is colliding with the dots
    ...
    # function to display score and powerup timer
    def draw_misc():
        ...
        if game_over:
            ...
            gameover_text = font.render('Game Over! Thanks for playing! Press spacebar to restart!', True, 'red')
            screen.blit(gameover_text, (100,300))
        if game_won:
            pygame.draw.rect(screen, 'white', [50,200,800,300], 0, 10)
            pygame.draw.rect(screen, 'black', [70,220,760,260], 0, 10)
            gameover_text = font.render('Victory! Thanks for playing! Press spacebar to restart!', True, 'green')
            screen.blit(gameover_text, (100,300))
    ...
    # function to create the pacman character
    def draw_player():
    ...
    # function to check collisions and if the change in direction is possible
    ...
    # function to move pacman character
